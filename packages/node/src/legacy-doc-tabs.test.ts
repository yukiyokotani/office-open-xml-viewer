...
it.skipIf(!skia).each(['custom', 'document-default', 'custom-over-default'] as const)('positions binary Word %s tabs through the ordinary DOCX layout and Canvas renderer', async (kind) => {
