//! Format-owned presentation wire models and pure transform helpers.
//!
...
// TS renderer consumes without a per-field adapter. Both the classic chart
...
pub use ooxml_common::chart::ChartModel;
...
pub use ooxml_common::fill::GradStop;
...
pub struct Presentation {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub fol_hlink_color: Option<String>,
}
...
pub struct Slide {
    ...
    pub element_sources: Vec<SlideElementSource>,
...
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct SlideElementSource {
    pub origin: SlideElementOrigin,
}
...
pub struct PptxComment {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub modern_author_id: Option<String>,
    ...
    #[serde(skip_serializing_if = "Vec::is_empty", default)]
    pub anchors: Vec<PptxCommentAnchor>,
    ...
    #[serde(skip_serializing_if = "Vec::is_empty", default)]
    pub replies: Vec<PptxCommentReply>,
}

#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct PptxCommentReply {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct TableCell {
    ...
    #[serde(skip)]
    pub has_direct_fill: bool,
    /// Default run text colour inherited from the table style (`<a:tcTxStyle>`),
    /// used when a run carries no explicit colour. Hex, no `#`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub text_color: Option<String>,
    pub border_l: Option<Stroke>,
    pub border_r: Option<Stroke>,
    pub border_t: Option<Stroke>,
    pub border_b: Option<Stroke>,
    ...
    #[serde(skip)]
    pub has_direct_border_l: bool,
    #[serde(skip)]
    pub has_direct_border_r: bool,
    #[serde(skip)]
    pub has_direct_border_t: bool,
    #[serde(skip)]
    pub has_direct_border_b: bool,
    #[serde(skip)]
    pub has_direct_diagonal_tl: bool,
    #[serde(skip)]
    pub has_direct_diagonal_tr: bool,
    /// Diagonal from top-left to bottom-right (tl2br)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub diagonal_tl: Option<Stroke>,
    /// Diagonal from top-right to bottom-left (tr2bl)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub diagonal_tr: Option<Stroke>,
...
pub struct Sp3d {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub contour_clr: Option<String>,
    /// Extrusion side-wall colour (`<a:extrusionClr>` child).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub extrusion_clr: Option<String>,
    /// Preset surface material (`ST_PresetMaterialType`), default "warmMatte".
    pub prst_material: String,
    /// Top bevel.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bevel_t: Option<Bevel3d>,
    /// Bottom bevel.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bevel_b: Option<Bevel3d>,
}
...
pub struct PictureElement {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prst_adjust: Option<Vec<i64>>,
...
pub use ooxml_common::fill::{FillRect, TileInfo};

pub use ooxml_common::effect::{Glow, Reflection, Shadow, SoftEdge};
...
pub struct Stroke {
    ...
    #[serde(skip_serializing_if = "Vec::is_empty", default)]
    pub custom_dash: Vec<StrokeDashSegment>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub head_end: Option<ArrowEnd>,
    /// Arrow at the end of the line (tailEnd)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tail_end: Option<ArrowEnd>,
...
pub struct Paragraph {
    ...
    pub def_bold: Option<bool>,
    pub def_italic: Option<bool>,
    pub def_font_family: Option<String>,
...
impl GroupTransform {
    pub fn apply_to_transform(&self, t: Transform) -> Transform {
...
pub fn apply_group_transform_to_element(el: &mut SlideElement, gt: &GroupTransform) {
    match el {
...
pub struct PresentationBootstrap {
    ...
    pub hlink_color: Option<String>,
    pub fol_hlink_color: Option<String>,
    pub embedded_fonts: Vec<PptxEmbeddedFontRef>,
    pub slides: Vec<BootstrapSlide>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct PptxEmbeddedFontRef {
