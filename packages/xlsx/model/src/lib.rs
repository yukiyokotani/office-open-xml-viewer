...
mod tests {
    ...
    #[test]
    fn workbook_metadata_serialization_preserves_field_order_and_defaults() {
        ...
        assert_eq!(
            ...
            r##"{"sheets":[{"name":"Visible","sheetId":7,"rId":"rId3"},{"name":"Hidden","sheetId":9,"rId":"rId4","tabColor":"#123456","visibility":"veryHidden"}],"date1904":true}"##
        );
    }

    #[test]
    fn explicit_xf_zero_and_sparse_cell_coordinates_remain_distinct() {
        let rows = vec![Row {
            index: 12,
            height: None,
            custom_height: false,
            cells: vec![
                ...
                Cell {
                    col: 8,
                    row: 12,
                    value: CellValue::Number { number: 42.5 },
                    style_index: Some(0),
                    formula: None,
                    show_phonetic: false,
                },
        ...
        assert_eq!(
            ...
            r#"[{"index":12,"height":null,"cells":[{"col":2,"row":12,"value":{"type":"empty"}},{"col":8,"row":12,"value":{"type":"number","number":42.5},"styleIndex":0}]}]"#
        );
    }
}
