...
import { initFromBytes, toMarkdown } from '../../markdown/src/xlsx';
import xlsxWasmUrl from '../../markdown/wasm/xlsx/ooxml_markdown_xlsx_bg.wasm?url';

type Args = Record<string, never>;

const meta: Meta<Args> = {
  title: 'XlsxViewer/Markdown',
};
export default meta;
...
const DEMO_URL = `${import.meta.env.BASE_URL}xlsx/demo/sample-1.xlsx`;
...
export const Markdown: Story = {
  ...
  render() {
    ...
    pre.textContent = `Pick a .xlsx file or click "Load demo".`;
    root.append(pre);
