  ...
  pptx: [
    ...
    },
    {
      ...
      methods: [
        ...
        { sig: 'applyShapeChanges(request): PptxShapeChangesResult', desc: 'Atomically apply a serializable, model-aware request in `mode: "main"`. Discriminated changes expose typed shape/text/paragraph/run patches and explicit structural operations, returning detached applied and inverse batches for undo/redo.' },
