  ...
  pptx: [
    ...
    },
    {
      ...
      methods: [
        ...
        { sig: 'applyShapeChanges(request): PptxShapeChangesResult', desc: 'Atomically apply serializable top-level ShapeElement deltas in `mode: "main"`. Nested values such as textBody are replaced whole; the method returns detached applied and inverse batches for undo/redo.' },
