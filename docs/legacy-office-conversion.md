...
retain the base palette formatting. Theme-dependent and tinted extension colors,
gradient fills, and font-scheme extensions still use the base-format fallback;
extended-style warnings remain. No migration is required.
...
DOC inline/floating images and PPT picture/background images can retain passive
